...
use crate::{
    AppStorage, FrostParticipantInternalData, RustFfiError, RustFfiResult, RustTypeActivityInfo,
...
pub(crate) struct StoredOrgInfo {
    ...
    pub(crate) activities: HashMap<String, FrostParticipantInternalData>,
}
